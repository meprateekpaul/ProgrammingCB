...
notebook_sol["cells"][4]["outputs"] = [{"name": "stdout", "output_type": "stream", "text": ["Score: 3\n"]}]
...
notebook_sol["cells"][7]["outputs"] = [{"name": "stdout", "output_type": "stream", "text": ["Hamming Distance: 2\n"]}]
...
notebook_sol["cells"][10]["outputs"] = [{"name": "stdout", "output_type": "stream", "text": ["[0, -2, -4, -6, -8]\n[-2, 0, 0, 0, 0]\n[-4, 0, 0, 0, 0]\n[-6, 0, 0, 0, 0]\n"]}]
...
with open("Notebooks/Exercises/Tutorial_2_Sequence_Alignment.ipynb", "w") as f:
    json.dump(notebook_ex, f, indent=1)

with open("Notebooks/Solutions/Tutorial_2_Sequence_Alignment_Solutions.ipynb", "w") as f:
